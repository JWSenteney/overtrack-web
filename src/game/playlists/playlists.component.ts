			...
			<div class="panel with-nav-tabs panel-default" style="width: 100%;">
				<div class="panel-heading">
					<ul class="nav nav-tabs">
						<li><b>VOD:</b></li>
						<li
							class="{{ f ? 'active' : '' }} titleize"
							*ngFor="let tab of tabs; let f = first"
						>
							<a (click)="changeTab(tab)" href="#{{ tab }}" data-toggle="tab">{{
								tab
							}}</a>
						</li>
					</ul>
...
export class PlaylistsComponent implements OnInit {
	...
	private tabOrdering = ["vod", "Kills", "Resurrects", "Deaths", "Ults"];
